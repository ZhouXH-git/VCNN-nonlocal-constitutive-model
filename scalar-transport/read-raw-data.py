...
for row in dfdata.itertuples():
    ...
    df6 = df5.drop(columns=['T']) # drop the label column
    df6['rfianl']=list(map(lambda x,y,u,v: rfinalfunc(x,y,u,v),df6['Cx'],df6['Cy'],df6['u'],df6['v'])) 
    
    dataX_current[data_ind,:,:]=df6.to_numpy()
